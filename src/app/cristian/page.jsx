    ...
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        ...
        <div style={styles.profile}>
          <Image
            src="https://res.cloudinary.com/dd8snmdx4/image/upload/v1726231832/empleados/iazljas1sujsaduoyic9.png"
            alt="Foto de perfil"
            width={40}
            height={40}
      ...
      <section style={styles.studentSection}>
        <div style={styles.profileContainer}>
          <Image
            src="https://res.cloudinary.com/dd8snmdx4/image/upload/v1726231741/empleados/glh0htv6zcpnbopsv9ti.png"
            alt="Bautista Ruiz Cristhian Alexander"
            width={100}
            height={100}
            style={styles.profilePicture}
          />
          <h3 style={styles.studentName}>BAUTISTA RUIZ CRISTHIAN ALEXANDER</h3>
          ...
          <div style={styles.infoSection}>
            ...
            <div style={styles.infoRow}>
              ...
              <p style={styles.value}>cbautistar21_2@unc.edu.pe</p>
            </div>
            <div style={styles.infoRow}>
